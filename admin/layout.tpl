...
<html lang="{{ lang.getLocale}}">
	...
	<body>
		<div id="container">
			...
			<div id="body">
				<div id="content_mask">
					<div id="content" class="{% if runPlugin %}{{ runPlugin.getName }}-admin{% else %}core-module-admin{% endif %}">
						{% IF runPlugin && runPlugin.getParamTemplate %}
						...
						{% ENDIF %}
						{% IF runPlugin && runPlugin.getHelpTemplate %}
